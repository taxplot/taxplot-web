...
const TestPage = () => {
    ...
    console.log(payrollTax(payrollInfo2021Single, updateTaxPayer(5000)).OASDI.Employee)
    for ( i = 0 ; i <= 300000 ; i += 1000 ) {
        dataObject.push({x:i, y:payrollTax(payrollInfo2021Single, updateTaxPayer(i)).OASDI.Employee})
    }
